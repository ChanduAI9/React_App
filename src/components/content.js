...
function TabsExample() {
  const dataMappings = {
    button1: {
      name: 'Bird Strikes',
      heading1: "Bird spike nets deter perching birds, offering human, low-maintenance protection.",
      img:"image1.png",
    ...
    button2: {
      ...
      heading1: "Durable pigeon safety nets deter bird infestations, protect property, and ensure hygiene with proper maintenance.",
      img:"",
    ...
    button3: {
      ...
      heading1: "A children's safety net offers holistic support, including education, healthcare, and legal protection, ensuring children's well-being and development.",
      img:"",
    ...
    button4: {
      name: 'Anti Bird Nets',
      heading1: "Anti-bird nets deter birds from roosting, protecting crops, preventing damage, and maintaining cleanliness, offering a humane and eco-friendly solution.",
      img:"",
    ...
    button5: {
      ...
      heading1: "Duct area safety nets are vital for worker safety in confined or elevated spaces, acting as a protective barrier against falls and hazards.",
      img:"",
    ...
    button6: {
      ...
      heading1: "Construction safety nets prevent accidents, protect workers, and reduce injuries by catching falling objects or individuals on construction sites.",
      img:"",
    ...
    button7: {
      ...
      heading1: "Industrial safety nets safeguard employees and equipment by catching falling objects, crucial for safer workplaces.",
      img:"",
    ...
    button8: {
      ...
      heading1: "Coconut safety nets provide essential protection from falling coconuts, ensuring safety in coconut tree-rich areas.",
      img:"",
    ...
    button9: {
      ...
      heading1: "Pets safety nets protect your furry friends from falling or escaping. It keeps pets safe in all aspects",
      img:"",
    ...
    button10: {
      ...
      heading1: "Balcony safety nets are vital for preventing accidents and ensuring safety, especially for children and pets, in high-rise buildings.",
      img:"",
    ...
    button11: {
      ...
      heading1: "Swimming pool safety nets are crucial for preventing accidental drowning, ensuring the safety of children and pets while maintaining pool access.",
      img:"",
    ...
    button12: {
      name: 'Shade Nets',
      heading1: "Shade nets offer sun protection for crops and outdoor spaces, promoting healthy growth and comfort in hot weather.",
      img:"",
    ...
    button13: {
      ...
      heading1: "Sports nets are essential for various sports, ensuring fair play and containment of balls in different materials and sizes.",
      img:"",
    ...
    button14: {
      ...
      heading1: "Cricket practice nets are dedicated enclosures for players to enhance batting, bowling, and fielding skills, essential for training and performance improvement.",
      img:"",
    ...
    button15: {
      ...
      heading1: "Artificial grass, a low-maintenance alternative to real grass, offers a lush, green appearance for residential, sports, and commercial spaces.",
      img:"",
    ...
    button16: {
      name: 'Mosquito Nets',
      heading1: "Mosquito nets are vital barriers against disease-carrying insects, especially effective in preventing mosquito-borne illnesses.",
      img:"",
    ...
    button17: {
      ...
      heading1: "Cricket pitch turf is meticulously prepared to provide a smooth, consistent bounce for fair and competitive gameplay, with grass type and maintenance tailored to local conditions.",
      img:"",
    ...
    button18: {
      ...
      heading1: "Glass safety nets offer both safety and aesthetics, providing protection in elevated areas while maintaining transparency and design aesthetics.",
      img:"",
    ...
    button19: {
      ...
      heading1: "Monkey safety nets are robust barriers preventing monkey intrusions in various settings, ensuring safety and cleanliness.",
      img:"",
    ...
    // Add more buttons and data as needed
  };
  const [jsonData, setJsonData] = useState(dataMappings.button1); // Set initial data to button1's data
  ...
  return (
    ...
    style={{"backgroundColor":'#049E79'}}
     size="lg" 
      ...
      <ListGroup as="ul" id="listGroupDropdowns"className="collapse d-md-block" >
      <ListGroup.Item as="li" className='listlink'  onClick={() => updateData('button1')}>Bird Spikes</ListGroup.Item>
      <ListGroup.Item as="li" className='listlink' onClick={() => updateData('button2')}>Pegion Safety Nets</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink' onClick={() => updateData('button3')}>Children Safety Nets</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink' onClick={() => updateData('button4')}>Anti Bird Nets</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink'onClick={() => updateData('button5')}>Duct Area Safety Nets</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink' onClick={() => updateData('button6')}>Construction Safety Nets</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink' onClick={() => updateData('button7')}>Industrial Safety Nets</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink' onClick={() => updateData('button8')}>Coconut Safety Nets</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink' onClick={() => updateData('button9')}>Pets Safety Nets</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink' onClick={() => updateData('button10')}>Balcony Safety Nets</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink' onClick={() => updateData('button11')}>Swimming pool Safety Nets</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink' onClick={() => updateData('button12')}>Shade Nets</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink' onClick={() => updateData('button13')}>All Sports  Nets</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink' onClick={() => updateData('button14')}> Cricket Practice Nets</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink' onClick={() => updateData('button15')}>Artificial Grass</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink' onClick={() => updateData('button16')}>Mosquito Nets</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink' onClick={() => updateData('button17')}>Turf For Cricket Pitch</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink' onClick={() => updateData('button18')}>Glass Safety Nets</ListGroup.Item>
      <ListGroup.Item as="li"className='listlink' onClick={() => updateData('button19')}>Monkey Saftey Nets</ListGroup.Item>
      <ListGroup.Item as="li" className='listlink' onClick={() => updateData('button20')}>Pegion Net for Balcony</ListGroup.Item>
    </ListGroup>
      </Col>
      <Col xs={12} md={9} lg={9} sm={12}>
       <h5 className='heading2'>{name}</h5>
       <Row>
        <Col lg={12}>       <h2 className='heading1' >{heading1}</h2></Col>
      <Col lg={3}>  </Col>
      </Row>
      <Image src={process.env.PUBLIC_URL+img}  alt='image1 of vb' fluid />
     <p className='p1a' >{p1}</p>
<p className='p1a'>{p2} </p>
<p className='p1a'>{p3} </p>
      <h6 className='h6a' >Benifits</h6>
      <Row className='Rowa'>
        <Col  xs={1} md={1} lg={1} sm={1} className='col1a' > <img src={correct} alt="correct-img" ></img>
        </Col>
        <Col xs={11} md={11} lg={8} sm={11}>{col1}</Col>
        </Row>
        <Row  className='Rowa'>
        <Col  xs={1} md={1} lg={1} className='col1a'> <img src={correct} alt="correct-img" ></img>
        </Col>
        <Col  xs={11} md={8} lg={8}>{col2} </Col>
        </Row >
        <Row  className='Rowa'>
        <Col  xs={1} md={1} lg={1} className='col1a'> <img src={correct} alt="correct-img"></img>
        </Col>
        <Col xs={11} md={8} lg={8}>{col3} </Col>
        </Row>
        <Row  className='Rowa'>
        <Col  xs={1} md={1} lg={1} className='col1a'> <img src={correct} alt="correct-img" ></img>
        </Col>
        <Col xs={11} md={8} lg={8}>{col4}</Col>
        </Row>
      
       <div className='heading1'> <Button className='but'>CONTACT</Button> </div>
</Col>  </Row>
</Container>
  );
}
